            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item" href="#"><i class="fas fa-laptop"></i> Tecnología</a> <!-- Icono de laptop -->
                        <a class="dropdown-item" href="#"><i class="fas fa-tshirt"></i> Ropa</a> <!-- Icono de camiseta -->
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="#"><i class="fas fa-ellipsis-h"></i> Otros</a> <!-- Icono de puntos suspensivos -->
                    </div>
                </li>
            </ul>
        </div>
