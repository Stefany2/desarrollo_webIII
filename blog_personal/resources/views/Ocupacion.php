...
<head>
    ...
    <style>
        ...
        .container {
            border: 3px solid #AF7AC5; /* Bordes como una página */
            padding: 20px;
...
<body>
    ...
    <div class="jumbotron text-center">
        <h1>OCUPACIÓN</h1>
        <p>¡Hola a todos!,aqui les comparto un poco sobre a que me dedico actualmente</p>
    </div>

    <!-- Sección de contenido -->
    <div class="container">
        <p>Actualmente siguo estudiando, estoy en el 4° semestre de mi carrera profesional, que es Ingeniería de Software con Inteligencia Artificial, en la ciudad de Huánuco.</p>
        <p>Elegi esta carrera porque me gusta la tecnología y las innovaciones que se van creando a lo largo de los años.</p>
        <p>En este semestre estoy realizando mis prácticas pre-profesionales para mejorar mis conocimientos y habilidades.</p>
    ...
    <div class="container my-4">
        <div class="row">
            <div class="col-md-4">
                <img src="https://via.placeholder.com/300x200" alt="Imagen 1" class="img-fluid rounded"> <!-- Imagen 1 -->
            </div>
            <div class="col-md-4">
                <img src="https://via.placeholder.com/300x200" alt="Imagen 2" class="img-fluid rounded"> <!-- Imagen 2 -->
            </div>
            <div class="col-md-4">
                <img src="https://via.placeholder.com/300x200" alt="Imagen 3" class="img-fluid rounded"> <!-- Imagen 3 -->
            </div>
        </div>
    </div>
