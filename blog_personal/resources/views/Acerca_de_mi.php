...
<body>
    ...
    <div class="jumbotron text-center">
        <h1>ACERCA DE MI</h1>
        <p>Aqui te comparto sobre mi.</p>
    </div>

    <!-- Sección de contenido -->
    <div class="container">
        <p>¡Hola a todos! me llamo Camila Stefany,tengo 19 años vivo en la cuidad de Huánuco.</p>
        <p>Actualmente estudio en el instituto de educación superior (SENATI).Soy sociable,carismatica, alegre, me gusta trabajar en equipo.</p>
        <p>Mi meta es graduarme el 2025.Estudio con una beca que me gane en los primeros puestos de mi colegio.</p>
        <p>Soy una chica soltera, con proyecciones a tener muchas cosas en el futuro y sobre todo siempre salir adelante.</p>
        <p>En mis ratos libres me gusta practicar, repasar mis apuntes,jugar futbol y leer.</p>
      ...
      <div class="container my-4">
        <div class="row">
            ...
            <div class="col-md-4">
                <img src="https://www.creative-tim.com/blog/content/images/size/w960/2022/01/which-development-job-is-right-for-you.jpg" alt="Imagen 3" class="img-fluid rounded"> <!-- Imagen 3 -->
            </div>
        </div>
    </div>
